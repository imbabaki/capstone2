...
<head>
    ...
    <title>Printing Instructions - QR Upload v2.0</title>
    ...
    <div class="main-container">
        <div class="content-section">
            <div class="gif-instructions">
                ...
                <div class="gif-step">
                    <div class="gif-step-title">STEP 2: Put the Paper in Printer</div>
                    ...
                    <div class="voucher-card-progress">
                        ...
                        <div class="voucher-code-box-progress">
                            ...
                            <div class="voucher-expiry">
                                ...
                                <div class="voucher-expiry-date">{{ $order['change_voucher_expires_at'] }}</div>
                            </div>
                            @endif
                        </div>
